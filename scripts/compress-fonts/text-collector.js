...
/**
 * 從 src/config/ 目錄下所有配置文件提取字符串
 * 配置已拆分爲多個文件（siteConfig、navBarConfig、profileConfig、musicConfig 等），需全部掃描
 */
