...
async function getData(
	...
	return (response?.data?.data?.list || []).map((bangumi) => {
		...
		if (bangumi?.publish?.release_date) {
			// 優先使用release_date，格式如 "2018-07-08"
		...
		// 如果沒有styles，使用season_type_name作爲備選
