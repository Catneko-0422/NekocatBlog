/**
 * 運行時性能監控工具
 * 收集 Core Web Vitals 指標並可選上報到分析服務
 */
...
/**
 * 觀察 First Input Delay (FID) / Interaction to Next Paint (INP)
 */
