...
class MusicPlayerStore {
	...
	toggleExpanded(): void {
		...
		// 保持與原先 usePlayerState.toggleExpandedUI 一致的聯動行爲：
		// 展開時強制取消隱藏，並關閉播放列表，避免狀態組合異常
	...
	toggleHidden(): void {
		...
		// 保持與原先 usePlayerState.toggleHiddenUI 一致的聯動行爲：
		// 隱藏時收起播放器並關閉播放列表，防止展開 UI 懸掛在小球旁邊
